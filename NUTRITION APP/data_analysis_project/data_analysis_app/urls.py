...
from .views import data_tab, descriptive_statistics_tab, exploratory_data_analysis_tab, profile_view, export_to_csv, export_to_excel, recommend_food
...
urlpatterns = [
    ...
    path('recommend-food/', recommend_food, name='recommend_food'),
]